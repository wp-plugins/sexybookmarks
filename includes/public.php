...
function sexy_publicStyles() {
	...
	if(get_post_meta($post->ID, 'Hide SexyBookmarks')) {
		...
		$surl = (!is_null($sexy_plugopts['custom-css'])) ? $sexy_plugopts['custom-css'] : SEXY_PLUGPATH.'css/style.min.css'; // If custom css, generated by sprite
		$surl = ($sexy_plugopts['custom-mods'] == 'yes') ? WP_CONTENT_URL.'/sexy-mods/css/style.min.css' : $surl; // If custom mods option is selected, pull files from new location
