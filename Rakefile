...
task :maketest do
  ...
  sh "rm -rf ../wordpress_local/wp-content/plugins/sexybookmarks"
  sh "cp -r ../shareaholic_for_wordpress ../wordpress_local/wp-content/plugins/sexybookmarks"
  sh "rm -rf `find ../wordpress_local/wp-content/plugins/sexybookmarks/ -name \".DS_Store\"`"
  sh "rm -rf `find ../wordpress_local/wp-content/plugins/sexybookmarks/ -name \"Thumbs.db\"`"
  sh "rm -rf `find ../wordpress_local/wp-content/plugins/sexybookmarks/ -name \".git\"`"
  sh "rm -rf `find ../wordpress_local/wp-content/plugins/sexybookmarks/ -name \".gitignore\"`"
  sh "rm -rf ../wordpress_local/wp-content/plugins/sexybookmarks/compiler"
end