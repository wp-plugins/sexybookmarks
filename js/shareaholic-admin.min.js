jQuery(document).ready(function(){jQuery("#iconator")&&jQuery("#shrsb-networks").sortable({delay:250,cursor:"move",scroll:true,revert:true,opacity:0.7,placeholder:"dropzoneNetworks",forcePlaceholderSize:true,items:"li"});if(jQuery(".shrsb-bookmarks")){jQuery("#shrsb-sortables").sortable({handle:".box-mid-head",delay:250,cursor:"move",scroll:true,revert:true,opacity:0.7});jQuery("#buttonPreviewsTop,#buttonPreviewsBottom").sortable({delay:250,cursor:"move",scroll:true,revert:true,opacity:0.7,placeholder:"dropzone",
forcePlaceholderSize:true,items:"li"});jQuery("#sel-all").click(function(){jQuery("#shrsb-networks").each(function(){jQuery("#shrsb-networks input").attr("checked","checked")})});jQuery("#sel-none").click(function(){jQuery("#shrsb-networks").each(function(){jQuery("#shrsb-networks input").removeAttr("checked")})});jQuery("#sel-pop").click(function(){jQuery("#shrsb-networks").each(function(){jQuery("#shrsb-networks input").removeAttr("checked")});jQuery("#shrsb-networks").each(function(){jQuery("#shr-facebook").attr("checked",
"checked");jQuery("#shr-twitter").attr("checked","checked");jQuery("#shr-linkedin").attr("checked","checked");jQuery("#shr-googlebookmarks").attr("checked","checked");jQuery("#shr-stumbleupon").attr("checked","checked");jQuery("#shr-reddit").attr("checked","checked");jQuery("#shr-gmail").attr("checked","checked");jQuery("#shr-mail").attr("checked","checked");jQuery("#shr-printfriendly").attr("checked","checked")})});jQuery("#preset-amounts").parent("label").click(function(){jQuery("#custom-amounts").attr("disabled",
...
jQuery("#twitter-defaults").fadeOut()});jQuery("#shorty").change(function(){jQuery("#shortyapimdiv-bitly").fadeOut("fast");jQuery("#shortyapimdiv-awesm").fadeOut("fast");jQuery("#shortyapimdiv-supr").fadeOut("fast");jQuery("#shortyapimdiv-jmp").fadeOut("fast");this.value=="bitly"?jQuery("#shortyapimdiv-bitly").fadeIn("fast"):this.value=="awesm"?jQuery("#shortyapimdiv-awesm").fadeIn("fast"):this.value=="supr"?jQuery("#shortyapimdiv-supr").fadeIn("fast"):this.value=="jmp"&&jQuery("#shortyapimdiv-jmp").fadeIn("fast")});
...
jQuery("#shrsbresetallwarn").fadeOut();this.checked=jQuery("#resetalloptionsaccept").submit();this.checked=!this.checked});var c=0;typeof jQuery("#tweetconfig")!="undefined"&&jQuery("#tweetconfig").length>0&&(jQuery("#tweetconfig").val().indexOf("${title}")!=-1&&(c=Math.floor(c+8)),jQuery("#tweetconfig").val().indexOf("${short_link}")!=-1&&(c=Math.floor(c+13)),c=Math.floor(jQuery("#tweetconfig").val().length-c),c>=50?jQuery("#tweetcounter span").addClass("error"):jQuery("#tweetcounter span").removeClass(),
jQuery("#tweetcounter span").html(c),c=jQuery("#tweetconfig").val(),c=c.replace("${title}","Some fancy post title"),c=c.replace("${short_link}","http://goo.gl/dbqlx"),jQuery("#tweetoutput span").html(c),jQuery("#tweetconfig").keyup(function(){var c=0;jQuery("#tweetconfig").val().indexOf("${title}")!=-1&&(c=Math.floor(c+8));jQuery("#tweetconfig").val().indexOf("${short_link}")!=-1&&(c=Math.floor(c+13));c=Math.floor(jQuery(this).val().length-c);if(c>=50)return jQuery("#tweetcounter span").addClass("error"),
alert("You need to leave room for the short URL and/or post title..."),false;else jQuery("#tweetcounter span").removeClass();jQuery("#tweetcounter span").html(c);c=jQuery(this).val();c=c.replace("${title}","Some fancy post title");c=c.replace("${short_link}","http://goo.gl/dbqlx");jQuery("#tweetoutput span").html(c)}));typeof jQuery("#likeButtonSetTop-yes")!="undefined"&&jQuery("#likeButtonSetTop-yes").length>0&&(jQuery("#likeButtonSetTop-yes").get(0).checked&&jQuery(".likeButtonsAvailableTop").fadeIn("fast"),
...
jQuery("body").bind("click",function(){jQuery("#tip_text_color_picker_holder").hide();jQuery("body").unbind("click")});return false}),jQuery("#tip_text_color_picker_holder").click(function(){return false}),jQuery("#tip_text_color_reset").bind("click",function(){jQuery("#tip_text_color").val("#ffffff");jQuery("#tip_text_color_picker div").css("backgroundColor","#ffffff")}));typeof jQuery("#useSbSettings-no")!="undefined"&&jQuery("#useSbSettings-no").length>0&&(jQuery("#useSbSettings-no").get(0).checked&&
jQuery(".topbar_prefs").fadeIn("fast"),jQuery("#tb_bg_color_picker_holder").ColorPicker({flat:true,color:jQuery("#tb_bg_color").val(),onChange:function(c,d){jQuery("#tb_bg_color").val("#"+d);jQuery("#tb_bg_color_picker div").css("backgroundColor","#"+d)},onSubmit:function(c,d){jQuery("#tb_bg_color").val("#"+d);jQuery("#tb_bg_color_picker div").css("backgroundColor","#"+d);jQuery("#tb_bg_color_picker_holder").toggle()}}),jQuery("#tb_bg_color_picker_holder").find("input").each(function(){jQuery(this).attr("maxlength",
"50")}),jQuery("#tb_bg_color_picker div").bind("click",function(){jQuery("#tb_bg_color_picker_holder").toggle();jQuery("#tb_bg_color_picker_holder").ColorPickerSetColor(jQuery("#tb_bg_color").val());jQuery("body").trigger("click");jQuery("#tb_bg_color_picker_holder").is(":visible")&&jQuery("body").bind("click",function(){jQuery("#tb_bg_color_picker_holder").hide();jQuery("body").unbind("click")});return false}),jQuery("#tb_bg_color_reset").bind("click",function(){jQuery("#tb_bg_color").val("#000000");
jQuery("#tb_bg_color_picker div").css("backgroundColor","#000000")}),jQuery("#tb_bg_color_picker_holder").click(function(){return false}),jQuery("#tb_border_color_picker_holder").ColorPicker({flat:true,color:jQuery("#tb_border_color").val(),onChange:function(c,d){jQuery("#tb_border_color").val("#"+d);jQuery("#tb_border_color_picker div").css("backgroundColor","#"+d)},onSubmit:function(c,d){jQuery("#tb_border_color").val("#"+d);jQuery("#tb_border_color_picker div").css("backgroundColor","#"+d);jQuery("#tb_border_color_picker_holder").toggle()}}),
jQuery("#tb_border_color_picker_holder").find("input").each(function(){jQuery(this).attr("maxlength","50")}),jQuery("#tb_border_color_picker div").bind("click",function(){jQuery("#tb_border_color_picker_holder").toggle();jQuery("#tb_border_color_picker_holder").ColorPickerSetColor(jQuery("#tb_border_color").val());jQuery("body").trigger("click");jQuery("#tb_border_color_picker_holder").is(":visible")&&jQuery("body").bind("click",function(){jQuery("#tb_border_color_picker_holder").hide();jQuery("body").unbind("click")});
return false}),jQuery("#tb_border_color_reset").bind("click",function(){jQuery("#tb_border_color").val("#000000");jQuery("#tb_border_color_picker div").css("backgroundColor","#000000")}),jQuery("#tb_border_color_picker_holder").click(function(){return false}))}});
(function(c){var e=function(){var d=65,e={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:true,flat:false},j=function(a,b){var f=i(a);c(b).data("colorpicker").fields.eq(1).val(f.r).end().eq(2).val(f.g).end().eq(3).val(f.b).end()},o=function(a,b){c(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},l=function(a,b){c(b).data("colorpicker").fields.eq(0).val(k(i(a))).end()},
...
a.keyCode||-1;if(a>d&&a<=90||a==32)return false;c(this).parent().parent().data("colorpicker").livePreview===true&&m.apply(this)},m=function(a){var b=c(this).parent().parent(),f;if(this.parentNode.className.indexOf("_hex")>0){f=b.data("colorpicker");var h=this.value,d=6-h.length;if(d>0){for(var g=[],e=0;e<d;e++)g.push("0");g.push(h);h=g.join("")}h=n(t(h));f.color=f=h}else this.parentNode.className.indexOf("_hsb")>0?b.data("colorpicker").color=f=u({h:parseInt(b.data("colorpicker").fields.eq(4).val(),
10),s:parseInt(b.data("colorpicker").fields.eq(5).val(),10),b:parseInt(b.data("colorpicker").fields.eq(6).val(),10)}):(f=b.data("colorpicker"),h=parseInt(b.data("colorpicker").fields.eq(1).val(),10),d=parseInt(b.data("colorpicker").fields.eq(2).val(),10),g=parseInt(b.data("colorpicker").fields.eq(3).val(),10),h={r:Math.min(255,Math.max(0,h)),g:Math.min(255,Math.max(0,d)),b:Math.min(255,Math.max(0,g))},f.color=f=n(h));a&&(j(f,b.get(0)),l(f,b.get(0)),o(f,b.get(0)));p(f,b.get(0));q(f,b.get(0));r(f,b.get(0));
b.data("colorpicker").onChange.apply(b,[f,k(i(f)),i(f)])},E=function(){c(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},F=function(){d=this.parentNode.className.indexOf("_hex")>0?70:65;c(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");c(this).parent().addClass("colorpicker_focus")},G=function(a){var b=c(this).parent().find("input").focus(),a={el:c(this).parent().addClass("colorpicker_slider"),max:this.parentNode.className.indexOf("_hsb_h")>
