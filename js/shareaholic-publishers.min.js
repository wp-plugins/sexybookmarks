...
SHR4P.jQuery('.'+k).shareaholic_publishers(this);});};var myinit=function(){if(/(loaded|complete)/.test(document.readyState)){load_shareaholic();}else{jQuery(document).ready(function(){load_shareaholic();});}};if(typeof(SHR4P)=='undefined'){SHR4P={};}
