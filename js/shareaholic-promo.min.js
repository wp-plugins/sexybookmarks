...
0&&jQuery.cookie("no_cp")!=1&&(jQuery("#wpadminbar").length==0&&jQuery("body").prepend(a),jQuery("div#ext-promo-prompt").slideDown(),jQuery("div#ext-promo-prompt a.install").slideDown(),jQuery("div#ext-promo-prompt a.close").slideDown())},500)});
