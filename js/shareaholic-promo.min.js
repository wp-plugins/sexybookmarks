...
0&&jQuery.cookie("no_cp")!=1&&(jQuery("#wpadminbar").length==0&&jQuery("body").prepend(a),jQuery("div#ext-promo-prompt").slideDown(),jQuery("div#ext-promo-prompt a.install").slideDown(),jQuery("div#ext-promo-prompt a.close").slideDown())},1E3)});
function ext_promo_noThanks(){jQuery.cookie("no_cp","1",{expires:30,path:"/"});jQuery("div#ext-promo-prompt a.install").slideUp("fast",function(){jQuery(this).remove()});jQuery("div#ext-promo-prompt a.close").slideUp("fast",function(){jQuery(this).remove()});jQuery("div#ext-promo-prompt").slideUp("fast",function(){jQuery(this).remove()})};
