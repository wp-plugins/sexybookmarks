...
0&&jQuery.cookie("no_cp")!=1&&(jQuery("body").prepend(a),jQuery("#wpadminbar").length!=0&&jQuery("#ext-promo-prompt").css("margin-top",jQuery("#wpadminbar").css("height")),jQuery("div#ext-promo-prompt").slideDown(),jQuery("div#ext-promo-prompt a.install").slideDown(),jQuery("div#ext-promo-prompt a.close").slideDown())},500)});
