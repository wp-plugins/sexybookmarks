...
0&&jQuery.cookie("no_cp")!=1&&(jQuery("body").prepend(a),jQuery("#wpadminbar").length!=0&&jQuery("#ext-promo-prompt").css("margin-top",jQuery("#wpadminbar").css("height")),jQuery("div#ext-promo-prompt").show())},500)});function ext_promo_noThanks(){jQuery.cookie("no_cp","1",{expires:30,path:"/"});jQuery("div#ext-promo-prompt").hide()};
