...
".shareaholic-like-buttonset").each(function(){var a=SHR4P.jQuery(this),e=a.attr("data-shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=a.attr("data-shr_count");if(typeof c=="undefined"||!c)c="true";var b=a.attr("data-shr_size");if(typeof b=="undefined"||!b)b="standard";var g="";if(b=="medium")g="padding-top:1px !important;";g=SHR4P.jQuery("<div style='float:left; "+g+" margin:0px 0px 0px 10px !important;'/>").get(0);a.replaceWith(g);SHR4P.jQuery(g).append("<div/>");g=SHR4P.jQuery(g).find(":first-child").get(0);
gapi.plusone.render(g,{size:b,count:c,href:decodeURIComponent(e),callback:"SHR4P_trackPlusOneClick"})})},trackPlusOneClick:function(a){a.state=="on"&&SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=304&link="+encodeURIComponent(a.href),width:"1",height:"1"}).appendTo("body")}};var SHR4P_trackPlusOneClick=function(a){SHR4P.googPlusOneUtil.trackPlusOneClick(a)};
...
"undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(SHR4P.fbUtil.likeButtonsToRender[a]);SHR4P.fbUtil.renderFBWidgetCalled=true}},renderFBSendButtons:function(){SHR4P.jQuery(".shareaholic-fbsend",".shareaholic-like-buttonset").each(function(){if(SHR4P.fbUtil.hasFBNameSpace()){var a=SHR4P.jQuery(this),e=a.attr("data-shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=SHR4P.jQuery("<div style='float:left;padding-top:0px !important; margin:0px 5px !important;'/>").get(0);
a.replaceWith(c);a=SHR4P.jQuery('<fb:send href="'+e+'" width="60" font=""></fb:send>').appendTo(c);typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(a.get(0))}})},renderFBLikeButtons:function(){SHR4P.jQuery(".shareaholic-fblike",".shareaholic-like-buttonset").each(function(){var a=SHR4P.jQuery(this),e=a.attr("data-shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=a.attr("data-shr_layout");if(typeof c=="undefined"||!c)c="button_count";var b=a.attr("data-shr_showfaces");
...
typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(e.get(0))}else{a="30";g="60";switch(c){case "button_count":g="90";a="21";break;case "box_count":g="60";a="90";break;default:g="60";a="80"}SHR4P.jQuery('<iframe src="http://www.facebook.com/plugins/like.php?app_id=207766518608&amp;href='+e+"&amp;send=false&amp;layout="+c+"&amp;width="+g+"&amp;show_faces="+b+"&amp;action="+l+"&amp;colorscheme=light&amp;font&amp;height="+a+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+
