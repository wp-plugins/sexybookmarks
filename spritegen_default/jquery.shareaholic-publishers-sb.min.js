...
SHR4P.renderLikeButtons=function(){SHR4P.jQuery(".shareaholic-fblike",SHR4P.jQuery(".shareaholic-like-buttonset")).length>0&&setTimeout("SHR4P.fbUtil.addFBConnect()",0);SHR4P.jQuery(".shareaholic-googleplusone",SHR4P.jQuery(".shareaholic-like-buttonset")).length>0&&setTimeout("SHR4P.googPlusOneUtil.addGoogScript()",0)};
