...
duration:400,rel:"nofollow",target:"_blank",twitter_template:"${title} - ${short_link} via @Shareaholic",dontShowShareCount:false,tags:"",allowExternalTags:true,category:"",ctype:"",short_link:"",shortener:"google",shortener_key:"",custom_link:{},bgimg:"",bgimg_padding:"0 0 0 0",center:false,spaced:false,iframe_src:"/publishers",spriteimg:"",share_src:"http://www.shareaholic.com",localize:false,li_margin:0,"margin-top":20,"margin-bottom":20,"margin-left":0,"bgimg-padding-top":0,"bgimg-padding-left":0,
"icon-width":60,"icon-height":29,"icon-margin-top":3,"promo-height":c.shrlink?18:0,shrlink:false,twitter_overlay:true},c);SHR4P.debug("$.fn.shareaholic_publishers called");SHR4P.debug(a);if(b.browser.msie&&b.browser.version<"7.0")a["icon-height"]+=4;if(!a.link)a.link=document.location.href;if(a.bgimg!=null){c=b.trim(a.bgimg_padding).split(" ");a["bgimg-padding-top"]=c[0]?Number(c[0].replace(/[a-zA-Z]+/,"")):0;a["bgimg-padding-left"]=c[3]?Number(c[3].replace(/[a-zA-Z]+/,"")):0;a["margin-left"]=10}if(a.localize)a.iframe_src=
"/publishers.html";var j=function(){var e=0;if(!b.isEmptyObject(a.custom_link))e=b(a.custom_link).length;return a.service.split(",").length+e},n=function(){return a["margin-left"]+a["bgimg-padding-left"]},m=function(e){return Math.ceil(j()/Math.floor((e-n())/a["icon-width"]))},i=function(e){return a.expand?a["margin-top"]+a["bgimg-padding-top"]+a["icon-height"]+a["icon-margin-top"]+(m(e)==1?a["promo-height"]:0):k(e)},k=function(e){return a["margin-top"]+a["bgimg-padding-top"]+(a["icon-height"]+a["icon-margin-top"])*
m(e)+a["promo-height"]},d=function(e){SHR4P.debug("centering");var f=0;if(m(e)==1){SHR4P.debug("one row! do centering");f=(e-n()-j()*a["icon-width"])/2;SHR4P.debug("returning "+f+" margin")}return f},h=function(e){SHR4P.debug("spacing");SHR4P.debug("rows: "+m(e));var f=0;if(m(e)==1){SHR4P.debug("one row! spacing icons");f=Math.floor((e-n()-a["icon-width"]*j())/j());SHR4P.debug("returning "+f+" margin")}return f};this.each(function(){if(a.spaced)a.li_margin=h(b(this).width());var e={src:a.src,service:a.service,
apikey:a.apikey,link:a.link,title:a.title,notes:a.notes,bgimg:a.bgimg,bgimg_padding:a.bgimg_padding,rel:a.rel,target:a.target,twitter_template:a.twitter_template,localize:a.localize,share_src:a.share_src,spriteimg:a.spriteimg,tags:a.tags,allowExternalTags:a.allowExternalTags,category:a.category,ctype:a.ctype,custom_link:a.custom_link,li_margin:a.li_margin,short_link:a.short_link,shortener:a.shortener,shortener_key:a.shortener_key,shrlink:a.shrlink,expand:a.expand,dontShowShareCount:a.dontShowShareCount,
twitter_overlay:a.twitter_overlay};a.center&&b(this).css({"margin-left":d(b(this).width())});a.mode=="inject"?b(this).shareaholic(e):b(this).append(b('<iframe frameborder="0"/>').attr({src:[a.src+a.iframe_src,b.param(e)].join("?"),height:i(b(this).width()),width:b(this).width(),scrolling:"no","class":"share-iframe"}).css({height:k(b(this).width())}));if(a.expand){b(this).css({overflow:"hidden",height:i(b(this).width())});b(this).hover(function(){b(this).animate({height:k(b(this).width())},{duration:a.duration,
queue:false})},function(){b(this).animate({height:i(b(this).width())},{duration:a.duration,queue:false})})}});return this};var g=function(c,a){var j=function(){SHR4P.debug("bitly javascript loaded");var k=c.link;BitlyCB.mycallback=function(d){SHR4P.debug("bit.ly calls back with");SHR4P.debug(d);if(d.errorCode==0){SHR4P.debug("successfully shortened, calling callback with: ");d=d.results[k].shortUrl;SHR4P.debug("short_link: "+d);SHR4P.debug("type: "+typeof d);a(d)}};BitlyClient.call("shorten",{longUrl:k},
"BitlyCB.mycallback")};if(typeof BitlyClient=="undefined"){SHR4P.debug("loading bit.ly");var n=document.getElementsByTagName("head")[0];if(typeof n!="undefined"){var m=c.shortener_key.split("|"),i=document.createElement("script");i.src="http://bit.ly/javascript-api.js?version=latest&login="+m[0]+"&apiKey="+m[1];i.type="text/javascript";i.charset="utf-8";n.appendChild(i);i.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded"){SHR4P.debug("bit.ly loaded with onreadystatechange, init'ing");
j()}};i.onload=j}}else{SHR4P.debug("bit.ly already loaded.  init'ing");j()}};SHR4P.debug("initializing shareaholic plugin");b.fn.shareaholic=function(c){var a=b.extend({service:"",rel:"nofollow",target:"_blank",poller_timeout:200,link:"",title:"",notes:"",bgimg:"",bgimg_padding:"",twitter_template:"${title} - ${short_link}",tags:"",category:"",ctype:"",localize:false,custom_link:{},li_margin:0,share_src:"http://www.shareaholic.com",src:"http://www.shareaholic.com",api:{share:{v:"1",url:"/api/share/",
apitype:"1",source:"Shareaholic-Publishers"},sprite:{v:"2",url:"/api/sprite/"}},short_link:"",shortener:"google",shortener_key:"",shortener_services:{"bit.ly":function(d,h){g(d,h)}}},c);SHR4P.debug("$.fn.shareaholic called");SHR4P.debug(a);b(this).addClass("shareaholic-show-on-load");if(a.localize==true||a.localize=="true")a.localize=true;var j=function(d,h){return[d,b.param(h)].join("?")},n=function(d){for(var h=[],e=d.length,f=0;f<e;f++){for(var l=f+1;l<e;l++)if(d[f]===d[l])l=++f;h.push(d[f])}return h},
m=function(d,h,e){var f=e.custom_link[d+"_"+h];SHR4P.debug("adding link "+d+" "+h);return b("<li/>").addClass(f.li_class).append(b("<a/>").attr({href:f.link,title:f.tooltip,rel:e.rel,target:e.target,"class":"external"})).attr("style",f.style+";margin-left:"+e.li_margin+"px !important;")};c=a.localize?a.src+"/sprite.css":j(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,service:n(a.service.split(",")).sort().join(",")});b("#shareaholic-publisher-css").length==0&&b("head").append(b('<link rel="stylesheet" media="screen" id="shareaholic-publisher-css" href="'+
c+'"/>'));var i=b("<div/>").addClass("shr-bookmarks").append(b("<ul/>").addClass("shr-socials"));if(a.shrlink){c=b.getBrowser();if(c!=""){i.append(b('<div style="clear: both;"></div><div class="shr-getshr" style="visibility:hidden;font-size:10px !important"><a target="_blank" href="http://www.shareaholic.com/?src=pub">Get Shareaholic</a></div><div style="clear: both;"></div>'));i.find(".shr-getshr a").text("Get Shareaholic for "+c);b(this).hover(function(){i.find(".shr-getshr").css("visibility","visible")},
function(){i.find(".shr-getshr").css("visibility","hidden")})}}a.bgimg!="undefined"&&a.bgimg!=""&&i.addClass("shr-bookmarks-bg-shr").css({"margin-left":"10px",height:"100%","overflow-x":"hidden","overflow-y":"hidden",display:"block",padding:a.bgimg_padding,background:"transparent url("+a.bgimg+") no-repeat"});var k=i.find(".shr-socials");b(a.service.split(",")).each(function(d,h){var e="";if(h=="7")e=a.twitter_template;a.custom_link["before_"+d]&&m("before",d,a).appendTo(k);h=="7"&&a.twitter_overlay&&
!SHR4P.utils.isMobileBrowser()?b("<li/>").addClass("shr-"+h).addClass("shareaholic").append(b("<a/>").attr({rel:a.rel,title:SHR4P.tooltips[h],target:a.target,"class":"external"}).click(function(f){SHR4P.utils.showServiceLet(a,"twitter");f.preventDefault()})).attr("style","margin-left:"+a.li_margin+"px !important;").appendTo(k):b("<li/>").addClass("shr-"+h).addClass("shareaholic").append(b("<a/>").attr({href:j(a.share_src+a.api.share.url,{title:a.title,link:a.link,notes:a.notes,short_link:a.short_link,
shortener:a.shortener,shortener_key:a.shortener_key,v:a.api.share.v,apitype:a.api.share.apitype,apikey:a.apikey,source:a.api.share.source,template:e,service:h,ctype:a.ctype}),rel:a.rel,title:SHR4P.tooltips[h],target:a.target,"class":"external"})).attr("style","margin-left:"+a.li_margin+"px !important;").appendTo(k);if(!a.dontShowShareCount&&(h==5||h==7||h==2)){e=function(f){f=f.count;if(f>0){for(var l=b("<div/>").addClass("shr-count").appendTo(k.find(".shr-"+h)),o=0;o<9;o+=1)o!=4&&l.append(b("<div>"+
f+"</div>").addClass("shr-count-outline").css({left:10+o%3-1+"px",top:"-"+(11+parseInt(o/3)-1)+"px"}));l.append(b("<div>"+f+"</div>").addClass("shr-count-center").css({left:"10px",top:"-11px"}))}};if(h==5)SHR4P.utils.getFbShrCnt(a.link,e);else if(h==7)SHR4P.utils.getTwitShrCnt(a.link,e);else h==2&&SHR4P.utils.getDeliciousShrCnt(a.link,e)}a.custom_link["after_"+d]&&m("after",d,a).appendTo(k)});c=function(d){b(k).find("li a").each(function(){this.href=this.href+"&tags="+d})};a.allowExternalTags?SHR4P.utils.getTags(a.link,
a.tags,c):c(a.tags);c=function(d){if(d.spriteimg!="")return d.spriteimg;else if(d.localize)return d.src+"/sprite.png";else{var h=function(l,o){return l-o},e=n(d.service.split(",")).sort(h);SHR4P.debug("checking services: ");SHR4P.debug(e);var f=[];b(SHR4P.img_group).each(function(){var l=this;SHR4P.debug("checking img_group: ");SHR4P.debug(l);b(e).each(function(){SHR4P.debug("checking service: "+this);if(b.inArray(Number(this),l)>-1){SHR4P.debug("found! adding img_group");b.merge(f,l);return false}});
SHR4P.debug("req_services so far: ");SHR4P.debug(f)});SHR4P.debug("final req_services: ");f=f.sort(h);SHR4P.debug(f.join(","));return j(d.src+d.api.sprite.url,{v:d.api.sprite.v,apikey:d.apikey,apitype:"png",service:f.join(",")})}}(a);i.append(b('<style type="text/css">ul.shr-socials li.shareaholic{background-image:url('+c+") !important;}</style>"));i.appendTo(this);return this};b.extend({getBrowser:function(){var c=navigator.userAgent,a="";if(c.indexOf("MSIE")!=-1)a="Internet Explorer";else if(c.indexOf("Firefox")!=
-1)a="Firefox";else if(c.indexOf("Flock")!=-1)a="Flock";else if(c.indexOf("Chrome")!=-1)a="Google Chrome";else if(c.indexOf("Safari")!=-1)a="Safari";else if(c.indexOf("Opera")!=-1)a="Opera";else if(c.indexOf("Songbird")!=-1)a="Songbird";return a}})})(SHR4P.jQuery);SHR4P.ready=true;typeof SHR4P.onready!="undefined"&&SHR4P.onready()}};if(typeof SHR4P=="undefined")SHR4P={};SHR4P.ready=false;SHR4P.init=false;
SHR4P.params=function(){var b={},g=document.location.href.split("?");if(g.length==2){g=g[1].split("&");for(var c=0;c<g.length;c++){var a=g[c].split("=");if(a.length==2)b[unescape(a[0])]=unescape(a[1])}}return b};SHR4P.debug=function(b){if(SHR4P.debug_enabled)typeof console!="undefined"&&console?console.log(b):alert(b)};
SHR4P.load=function(){setTimeout("SHR4P.ga()",0);setTimeout("SHR4P.prefetch()",0);if(typeof jQuery!="undefined"&&jQuery){var b=jQuery().jquery;if(SHRSB_Globals.minJQueryVersion<=b){window.sb_dont_noConflict=true;SHR4P_init();return}}SHR4P.debug("loading jquery");b=document.getElementsByTagName("head")[0];if(typeof b!="undefined"){SHR4P.params();var g=document.createElement("script");g.src=SHR4P.debug_enabled?"//ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.js":"//ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js";
g.type="text/javascript";b.appendChild(g);g.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded"){SHR4P.debug("jQuery loaded with onreadystatechange, init'ing");SHR4P_init()}};g.onload=SHR4P_init}};SHR4P.onready=function(){/(loaded|complete)/.test(document.readyState)?SHR4P.readyHandler():SHR4P.jQuery(document).ready(function(){SHR4P.readyHandler()})};
...
SHR4P.utils={getFbShrCnt:function(b,g){b="http://api.ak.facebook.com/restserver.php?v=1.0&method=links.getStats&format=json&urls="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){var a=0;if(c.length>0){a=c[0].total_count;if(a!=0)if(a>1E3)a=Math.floor(a/1E3)+"K"}g({count:a})})},getTwitShrCnt:function(b,g){b="http://urls.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){c=c.count;if(c!=0)if(c>1E3)c=Math.floor(c/1E3)+
"K";g({count:c})})},getDeliciousShrCnt:function(b,g){b="http://feeds.delicious.com/v2/json/urlinfo/data?url="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){var a=0;if(c.length>0){a=c[0].total_posts;if(a!=0)if(a>1E3)a=Math.floor(a/1E3)+"K"}g({count:a})})},getTags:function(b,g,c){var a=1;SHR4P.utils.getDeliciousTag(b,function(j){g+=j;--a==0&&c(g)})},getDeliciousTag:function(b,g){b="http://feeds.delicious.com/v2/json/urlinfo/data?url="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+
"&callback=?",function(c){if(c.length>0){top_tags=c[0].top_tags;del_tags="";SHR4P.jQuery.each(top_tags,function(a,j){del_tags+=encodeURIComponent(a)+"|"+j+"|delicious,"});if(del_tags!="")del_tags=del_tags.substr(0,del_tags.length-1);g(del_tags)}})},showServiceLet:function(b,g){if(!(typeof g=="undefined"||!g)){if(typeof SHR_config=="undefined"||!SHR_config)window.SHR_config={};window.__shr_service=g;window.__shr_log=true;window.__shr_center=true;SHR_config.shortener=b.shortener?b.shortener:"google";
SHR_config.shortener_key=b.shortener_key?b.shortener_key:"";SHR_config.apikey=b.apikey?b.apikey:"8afa39428933be41f8afdb8ea21a495c";SHR_config.twitter_template=b.twitter_template?b.twitter_template:"${title} - ${short_link}";SHR_config.link=b.link?b.link:document.location.href;SHR_config.title=b.title?b.title:b.link?"":document.title;SHR_config.short_link=b.short_link?b.short_link:"";if(window.SHR&&window.SHR.Servicelet)SHR.Servicelet.show();else{var c=document,a=c.createElement("script");a.setAttribute("language",
"javascript");a.id="shr-servicelet";a.setAttribute("src",(b.share_src?b.share_src:"http://www.shareaholic.com")+"/media/js/servicelet.js");c.body.appendChild(a)}}},isMobileBrowser:function(){var b=navigator.userAgent||navigator.vendor||window.opera;return/android|avantgo|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(b)||
