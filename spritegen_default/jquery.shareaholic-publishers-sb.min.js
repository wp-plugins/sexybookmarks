...
li_margin:0,"margin-top":20,"margin-bottom":20,"margin-left":0,"bgimg-padding-top":0,"bgimg-padding-left":0,"icon-width":60,"icon-height":29,"icon-margin-top":3,"promo-height":d.shrlink?18:0,shrlink:!1,twitter_overlay:!0},d),d=b(this);SHR4P.debug("$.fn.shareaholic_publishers called");SHR4P.debug(a);b.browser.msie&&b.browser.version<"7.0"&&(a["icon-height"]+=4);if(!a.link||a.link&&a.link==="")a.link=d.attr("data-shr_href")||document.location.href;if(!a.title||a.title&&a.title==="")a.title=d.attr("data-shr_title")||
document.title;a.bgimg!=null&&(d=b.trim(a.bgimg_padding).split(" "),a["bgimg-padding-top"]=d[0]?Number(d[0].replace(/[a-zA-Z]+/,"")):0,a["bgimg-padding-left"]=d[3]?Number(d[3].replace(/[a-zA-Z]+/,"")):0,a["margin-left"]=10);if(a.localize)a.iframe_src="/publishers.html";var c=function(){var f=0;if(!b.isEmptyObject(a.custom_link))f=b(a.custom_link).length;return a.service.split(",").length+f},g=function(){return a["margin-left"]+a["bgimg-padding-left"]},f=function(b){return Math.ceil(c()/Math.floor((b-
g())/a["icon-width"]))},h=function(b){return a.expand?a["margin-top"]+a["bgimg-padding-top"]+a["icon-height"]+a["icon-margin-top"]+(f(b)==1?a["promo-height"]:0):i(b)},i=function(b){return a["margin-top"]+a["bgimg-padding-top"]+(a["icon-height"]+a["icon-margin-top"])*f(b)+a["promo-height"]},j=function(b){SHR4P.debug("centering");var d=0;f(b)==1&&(SHR4P.debug("one row! do centering"),d=(b-g()-c()*a["icon-width"])/2,SHR4P.debug("returning "+d+" margin"));return d},k=function(b){SHR4P.debug("spacing");
SHR4P.debug("rows: "+f(b));var d=0;f(b)==1&&(SHR4P.debug("one row! spacing icons"),d=Math.floor((b-g()-a["icon-width"]*c())/c()),SHR4P.debug("returning "+d+" margin"));return d};this.each(function(){if(a.spaced)a.li_margin=k(b(this).width());var f={src:a.src,service:a.service,apikey:a.apikey,link:a.link,title:a.title,notes:a.notes,bgimg:a.bgimg,bgimg_padding:a.bgimg_padding,rel:a.rel,target:a.target,twitter_template:a.twitter_template,localize:a.localize,share_src:a.share_src,spriteimg:a.spriteimg,
tags:a.tags,allowExternalTags:a.allowExternalTags,designer_toolTips:a.designer_toolTips,tip_bg_color:a.tip_bg_color,tip_text_color:a.tip_text_color,category:a.category,ctype:a.ctype,custom_link:a.custom_link,li_margin:a.li_margin,short_link:a.short_link,shortener:a.shortener,shortener_key:a.shortener_key,shrlink:a.shrlink,expand:a.expand,dontShowShareCount:a.dontShowShareCount,fbLikeButton:a.fbLikeButton,fbButtonPos:a.fbButtonPos,twitter_overlay:a.twitter_overlay};a.center&&b(this).css({"margin-left":j(b(this).width())});
a.mode=="inject"?b(this).shareaholic(f):b(this).append(b('<iframe frameborder="0"/>').attr({src:[a.src+a.iframe_src,b.param(f)].join("?"),height:h(b(this).width()),width:b(this).width(),scrolling:"no","class":"share-iframe"}).css({height:i(b(this).width())}));a.expand&&(b(this).css({overflow:"hidden",height:h(b(this).width())}),b(this).hover(function(){b(this).animate({height:i(b(this).width())},{duration:a.duration,queue:!1})},function(){b(this).animate({height:h(b(this).width())},{duration:a.duration,
queue:!1})}))});return this};var c=function(b,a){var c=function(){SHR4P.debug("bitly javascript loaded");var f=b.link;BitlyCB.mycallback=function(b){SHR4P.debug("bit.ly calls back with");SHR4P.debug(b);if(b.errorCode==0)SHR4P.debug("successfully shortened, calling callback with: "),b=b.results[f].shortUrl,SHR4P.debug("short_link: "+b),SHR4P.debug("type: "+typeof b),a(b)};BitlyClient.call("shorten",{longUrl:f},"BitlyCB.mycallback")};if(typeof BitlyClient=="undefined"){SHR4P.debug("loading bit.ly");
var g=document.getElementsByTagName("head")[0];if(typeof g!="undefined"){var f=b.shortener_key.split("|"),h=document.createElement("script");h.src="http://bit.ly/javascript-api.js?version=latest&login="+f[0]+"&apiKey="+f[1];h.type="text/javascript";h.charset="utf-8";g.appendChild(h);h.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded")SHR4P.debug("bit.ly loaded with onreadystatechange, init'ing"),c()};h.onload=c}}else SHR4P.debug("bit.ly already loaded.  init'ing"),
c()};SHR4P.debug("initializing shareaholic plugin");b.fn.shareaholic=function(d){var a=b.extend({service:"",rel:"nofollow",target:"_blank",poller_timeout:200,link:"",title:"",notes:"",bgimg:"",bgimg_padding:"",twitter_template:"${title} - ${short_link}",tags:"",category:"",ctype:"",localize:!1,custom_link:{},li_margin:0,share_src:SHR4P.base_url,src:SHR4P.base_url,api:{share:{v:"1",url:"/api/share/",apitype:"1",source:"Shareaholic-Publishers"},sprite:{v:"2",url:"/api/sprite/"}},short_link:"",shortener:"google",
shortener_key:"",shortener_services:{"bit.ly":function(b,a){c(b,a)}}},d);SHR4P.debug("$.fn.shareaholic called");SHR4P.debug(a);b(this).addClass("shareaholic-show-on-load");if(a.localize==!0||a.localize=="true")a.localize=!0;var e=function(a,f){return[a,b.param(f)].join("?")},g=function(b){for(var a=[],f=b.length,d=0;d<f;d++){for(var c=d+1;c<f;c++)b[d]===b[c]&&(c=++d);a.push(b[d])}return a},f=function(a,f,d){var c=d.designer_toolTips?"orig_title":"title",h=d.custom_link[a+"_"+f];SHR4P.debug("adding link "+
a+" "+f);return b("<li/>").addClass(h.li_class).append(b("<a/>").attr({href:h.link,rel:d.rel,target:d.target,"class":"external"}).attr(c,h.tooltip).text(h.tooltip)).attr("style",h.style+";margin-left:"+d.li_margin+"px !important;")},d=a.localize?a.src+"/sprite.css":e(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,service:g(a.service.split(",")).sort().join(",")});b("#shareaholic-publisher-css").length==0&&b("head").append(b('<link rel="stylesheet" media="screen" id="shareaholic-publisher-css" href="'+
d+'"/>'));var h=b("<div/>").addClass("shr-bookmarks").append(b("<ul/>").addClass("shr-socials"));a.shrlink&&(d=b.getBrowser(),d!=""&&(h.append(b('<div style="clear: both;"></div><div class="shr-getshr" style="visibility:hidden;font-size:10px !important"><a target="_blank" href="http://www.shareaholic.com/?src=pub">Get Shareaholic</a></div><div style="clear: both;"></div>')),h.find(".shr-getshr a").text("Get Shareaholic for "+d),b(this).hover(function(){h.find(".shr-getshr").css("visibility","visible")},
function(){h.find(".shr-getshr").css("visibility","hidden")})));a.bgimg!="undefined"&&a.bgimg!=""&&h.addClass("shr-bookmarks-bg-shr").css({"margin-left":"10px",height:"100%","overflow-x":"hidden","overflow-y":"hidden",display:"block",padding:a.bgimg_padding,background:"transparent url("+a.bgimg+") no-repeat"});var i=h.find(".shr-socials");if(a.fbLikeButton){setTimeout("SHR4P.fbUtil.addFBConnect()",0);var d=b('<div class="shareaholic-like-buttons"><br/></div>'),j=b('<a class="shareaholic-fb-like" style="margin-top:5px; margin-bottom:5px;"></a>');
SHR4P.fbUtil.addLikeButton(j,a.link);d.prepend(j);a.fbButtonPos.indexOf("bottom")!=-1?d.insertAfter(this):d.insertBefore(this);a.fbButtonPos.indexOf("right")!=-1&&j.css("float","right")}b(a.service.split(",")).each(function(d,c){var h="";if(c=="7")h=a.twitter_template;a.custom_link["before_"+d]&&f("before",d,a).appendTo(i);var j=a.designer_toolTips?"orig_title":"title",g=SHR4P.utils.getBrowserLocale(),g=g.split("-")[0];if(typeof SHR4P.locales!=="undefined"&&(typeof SHR4P.locales[g]=="undefined"||
!SHR4P.locales[g]))g="en";g=typeof SHR4P.locales!=="undefined"?SHR4P.locales[g][SHR4P.tooltips_prefix_map[c]]+" "+SHR4P.tooltips_suffix[c]:"";SHR4P.ga.socialAction({serviceId:c,serviceAction:"render",link:a.link});var k=b("<li/>");k.addClass("shr-"+c).addClass("shareaholic").attr("style","margin-left:"+a.li_margin+"px !important;").bind("click",{serviceId:c,serviceAction:"share",link:a.link},SHR4P.ga.trackAction);var p={title:a.title,link:a.link,notes:a.notes,short_link:a.short_link,shortener:a.shortener,
shortener_key:a.shortener_key,v:a.api.share.v,apitype:a.api.share.apitype,apikey:a.apikey,source:a.api.share.source,template:h,service:c,ctype:a.ctype};c=="7"&&a.twitter_overlay&&!SHR4P.utils.isMobileBrowser()?k.append(b("<a/>").attr({rel:a.rel,target:a.target,"class":"external"}).attr(j,g).text(g).click(function(b){SHR4P.utils.showServiceLet(a,"twitter");b.preventDefault()})).appendTo(i):k.append(b("<a/>").attr({href:e(a.share_src+a.api.share.url,p),rel:a.rel,target:a.target,"class":"external"}).attr(j,
g).text(g)).appendTo(i);c=="309"&&k.click(function(b){SHR4P.utils.runBookmarklet(p);b.preventDefault()});if(!a.dontShowShareCount&&(c==5||c==7||c==2))h=function(a){a=a.count;if(a>0||a!="0"&&a!=0){for(var f=b("<div/>").addClass("shr-count").appendTo(i.find(".shr-"+c)),d=0;d<9;d+=1)d!=4&&f.append(b("<div>"+a+"</div>").addClass("shr-count-outline").css({left:10+d%3-1+"px",top:"-"+(11+parseInt(d/3)-1)+"px"}).attr("aria-hidden","true"));f.append(b("<div>"+a+"</div>").addClass("shr-count-center").css({left:"10px",
top:"-11px"}).attr("aria-label","Number of times this webpage has been shared"))}},c==5?SHR4P.utils.getFbShrCnt(a.link,h):c==7?SHR4P.utils.getTwitShrCnt(a.link,h):c==2&&SHR4P.utils.getDeliciousShrCnt(a.link,h);a.custom_link["after_"+d]&&f("after",d,a).appendTo(i)});var k=function(){var a=b("<div style='position:absolute !important; background: transparent !important; z-index:101 !important;'/>"),f=b("<div class = 'shareaholic-tip-text'></div>"),d=b("<div class = 'shareaholic-arrow-down'/>");a.append(f);
a.append(d);return{show:function(d){if(!b("body").find(".shareaholic-tip-text").length){var c=b(d).find("a").attr("orig_title");f.text(c);c=b(d).offset();a.appendTo(document.body);var h=a.width(),d=b(d).width();a.css({left:c.left-h/2+d/2,top:c.top-32});a.css({opacity:0.9})}},hide:function(){a.remove()}}}();a.designer_toolTips&&(b("<style type='text/css'>.shareaholic-arrow-down{ position: absolute !important; left:45% !important; width: 0 !important; height: 0 !important; border-left: 6px solid transparent !important; border-right: 6px solid transparent !important; border-top: 6px solid "+
a.tip_bg_color+" !important; }.shareaholic-tip-text{font-size:12px !important; line-height:120% !important; background: "+a.tip_bg_color+" !important; color: "+a.tip_text_color+" !important; padding: 5px !important; border-radius: 5px !important; -webkit-border-radius:5px; !important; -moz-border-radius:5px; !important}</style>").appendTo("head"),i.find("li").mouseenter(function(a){k.show(a.currentTarget)}).mouseleave(function(a){k.hide(a.currentTarget)}));d=function(a){b(i).find("li a").each(function(){this.href=
this.href+"&tags="+a})};a.allowExternalTags?SHR4P.utils.getTags(a.link,a.tags,d):d(a.tags);d=function(a){if(a.spriteimg!="")return a.spriteimg;else if(a.localize)return a.src+"/sprite.png";else{var f=function(a,b){return a-b},d=g(a.service.split(",")).sort(f);SHR4P.debug("checking services: ");SHR4P.debug(d);var c=[];b(SHR4P.img_group).each(function(){var a=this;SHR4P.debug("checking img_group: ");SHR4P.debug(a);b(d).each(function(){SHR4P.debug("checking service: "+this);if(b.inArray(Number(this),
a)>-1)return SHR4P.debug("found! adding img_group"),b.merge(c,a),!1});SHR4P.debug("req_services so far: ");SHR4P.debug(c)});SHR4P.debug("final req_services: ");c=c.sort(f);SHR4P.debug(c.join(","));return e(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,apitype:"png",service:c.join(",")})}}(a);h.append(b('<style type="text/css">ul.shr-socials li.shareaholic{background-image:url('+d+") !important;}</style>"));h.appendTo(this);return this};b.extend({getBrowser:function(){var b=navigator.userAgent,
a="";b.indexOf("MSIE")!=-1?a="Internet Explorer":b.indexOf("Firefox")!=-1?a="Firefox":b.indexOf("Flock")!=-1?a="Flock":b.indexOf("Chrome")!=-1?a="Google Chrome":b.indexOf("Safari")!=-1?a="Safari":b.indexOf("Opera")!=-1?a="Opera":b.indexOf("Songbird")!=-1&&(a="Songbird");return a}})}(SHR4P.jQuery),SHR4P.ready=!0,typeof SHR4P.onready!="undefined")SHR4P.onready()};typeof SHR4P=="undefined"&&(SHR4P={});SHR4P.ready=!1;SHR4P.init=!1;
SHR4P.params=function(){var b={},c=document.location.href.split("?");if(c.length==2)for(var c=c[1].split("&"),d=0;d<c.length;d++){var a=c[d].split("=");a.length==2&&(b[unescape(a[0])]=unescape(a[1]))}return b};SHR4P.debug=function(b){SHR.debug_enabled&&(typeof console!="undefined"&&console?console.log(b):alert(b))};
SHR4P.load=function(){setTimeout("SHR4P.dough()",0);setTimeout("SHR4P.media6()",0);setTimeout("SHR4P.prefetch()",0);if(typeof jQuery!="undefined"&&jQuery){var b=jQuery().jquery;if(SHRSB_Globals.minJQueryVersion<=b){window.sb_dont_noConflict=!0;SHR4P_init();return}}SHR4P.debug("loading jquery");b=document.getElementsByTagName("head")[0];if(typeof b!="undefined"){SHR4P.params();var c=document.createElement("script");c.src=SHR.debug_enabled?"//ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.js":"//ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js";
...
SHR4P.readyHandler=function(){SHR4P.utils.init(SHR4P.jQuery);SHR4P.renderLikeButtons();SHR4P.jQuery.each(SHRSB_Settings,function(b){this.expand=="false"&&(this.expand=!1);SHR4P.jQuery("."+b).shareaholic_publishers(this)})};SHR4P.img_group=[];SHR4P.img_group[0]=[2,3,4,5,6,7,10,24,38,39,40,52,54,74,88,201,219,257];SHR4P.img_group[1]=[27,33,41,43,45,46,53,73,78,195,196,205,207,210,236,247,264];SHR4P.img_group[2]=[44,48,61,80,100,105,140,191,202,218,238,240,266,269,280,289];
...
SHR4P.utils=function(b,c){function d(a,b){return[a,e.param(b)].join("?")}function a(a){if(!a.src)throw"Invalid source";a=e.extend({},{async:!0,cache:!1,src:!1,id:""},a);if(!a.cache)a.r=Math.floor(Math.random()*9999999999),a.src+="&_="+a.r,a.id+=a.r;var b=c.createElement("script");b.setAttribute("language","javascript");b.id=a.id;b.async=a.async;b.setAttribute("src",a.src);c.body.appendChild(b);return a}var e,g={v:1,apikey:"0747414f47c2b684cf5480c36b2478689",apitype:1,title:"",link:"",short_link:"",
shortener:"google",shortener_key:"",template:"${title} - ${short_link}",service:!1,source:"Shareaholic-Publishers",tags:"",ctype:"",notes:""};return{init:function(a){e=a},url:d,appendScript:a,runBookmarklet:function(b){if(typeof b.service!="undefined"&&b.service){b.apitype=4;var c=SHR4P.base_url+"/api/share",i=e.extend({},g,b);a({src:d(c,i),cache:!1,id:b.service+"_shareaholic_"})}},getFbShrCnt:function(a,b){a="http://api.ak.facebook.com/restserver.php?v=1.0&method=links.getStats&format=json&urls="+
encodeURIComponent(a);SHR4P.jQuery.getJSON(a+"&callback=?",function(a){var c=0;if(a.length>0)c=a[0].total_count,c!=0&&c>1E3&&(c=Math.floor(c/1E3)+"K");b({count:c})})},getTwitShrCnt:function(a,b){a="https://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(a);SHR4P.jQuery.getJSON(a+"&callback=?",function(a){a=a.count;a!=0&&a>1E3&&(a=Math.floor(a/1E3)+"K");b({count:a})})},getDeliciousShrCnt:function(a,b){a="http://feeds.delicious.com/v2/json/urlinfo/data?url="+encodeURIComponent(a);SHR4P.jQuery.getJSON(a+
"&callback=?",function(a){var c=0;if(a.length>0)c=a[0].total_posts,c!=0&&c>1E3&&(c=Math.floor(c/1E3)+"K");b({count:c})})},getTags:function(a,b,c){var d=1;SHR4P.utils.getDeliciousTag(a,function(a){b+=a;--d==0&&c(b)})},getDeliciousTag:function(a,b){a="http://feeds.delicious.com/v2/json/urlinfo/data?url="+encodeURIComponent(a);SHR4P.jQuery.getJSON(a+"&callback=?",function(a){if(a.length>0)top_tags=a[0].top_tags,del_tags="",SHR4P.jQuery.each(top_tags,function(a,b){del_tags+=encodeURIComponent(a)+"|"+
b+"|delicious,"}),del_tags!=""&&(del_tags=del_tags.substr(0,del_tags.length-1)),b(del_tags)})},showServiceLet:function(d,h){if(typeof h!="undefined"&&h){if(typeof SHR_config=="undefined"||!SHR_config)window.SHR_config={};b.__shr_service=h;b.__shr_log=!0;b.__shr_center=!0;SHR_config.shortener=d.shortener?d.shortener:"google";SHR_config.shortener_key=d.shortener_key?d.shortener_key:"";SHR_config.apikey=d.apikey?d.apikey:"0747414f47c2b684cf5480c36b2478689";SHR_config.twitter_template=d.twitter_template?
d.twitter_template:"${title} - ${short_link}";SHR_config.link=d.link?d.link:c.location.href;SHR_config.title=d.title?d.title:d.link?"":c.title;SHR_config.short_link=d.short_link?d.short_link:"";b.SHR&&b.SHR.Servicelet?SHR.Servicelet.show():a({src:(d.share_src?d.share_src:SHR4P.cdn_url)+"/media/js/servicelet.min.js",cache:!0,id:"shr-servicelet"})}},isMobileBrowser:function(){var a=navigator.userAgent||navigator.vendor||window.opera;return/android|avantgo|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(a)||
...
SHR4P.ga=function(){function b(b){!a&&d();if(!g)return!1;var c=b.serviceAction||"unknown",e=typeof h[c]!=="undefined"?h[c]:!0,l=b.link,b=f+(SHR4P.tooltips_suffix[b.serviceId]||""),b=b.replace(/(\s|\r\n|\n|\r)/gm,"_"),c=c.charAt(0).toUpperCase()+c.slice(1);e&&_gaq.push([i+"_trackSocial",b,c,l]);return e}function c(){typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"&&function(){var a=document.createElement("script");a.type="text/javascript";a.async=!0;a.src=("https:"==document.location.protocol?
"https://ssl":"http://www")+".google-analytics.com/ga.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}()}function d(){if(typeof _gaq=="undefined"||!_gaq)window._gaq=[];_gaq.push(["shr._setAccount","UA-12964573-5"],["shr._trackPageview"]);typeof SHRSB_Globals!=="undefined"&&((e=SHRSB_Globals.pubGaKey||!1)&&(i="shrpub."),g=typeof SHRSB_Globals.pubGaSocial!=="undefined"?SHRSB_Globals.pubGaSocial:g,e&&g&&_gaq.push([i+"_setAccount",e]));a=!0;c()}var a=!1,e,g=!0,f="Shareaholic_",
h={render:!1,like:!0,unlike:!0,send:!0,share:!0,unknown:!1},i="";return{init:d,socialAction:b,trackAction:function(a){b(a.data)}}}();
...
".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery(this);if((b.attr("data-shr_status")||!1)!="1"){var c=b.attr("data-shr_href")||b.attr("shr_href"),d=b.attr("data-shr_title")||b.attr("shr_title"),a=b.attr("data-shr_size")||b.attr("shr_size"),e=b.attr("data-shr_count")||b.attr("shr_count"),g=b.attr("data-shr_annotation"),f=b.attr("data-shr_width"),h=b.attr("data-shr_expandto"),i=b.attr("data-shr_onstartinteraction"),j=b.attr("data-shr_onendinteraction");if(typeof e=="undefined"||!e)e=
"true";if((typeof c=="undefined"||!c)&&(typeof d=="undefined"||!d))c=encodeURIComponent(document.location.href),d=document.title;else{if(typeof c=="undefined"||!c)c=encodeURIComponent(document.location.href);if(typeof d=="undefined"||!d)d=""}if(typeof a=="undefined"||!a)a="standard";if(typeof g=="undefined"||!g)g="inline",g=typeof e!=="undefined"&&e&&e!=="false"?"inline":"none";if(typeof f=="undefined"||!f)f="450px";if(typeof h=="undefined"||!h)h="";if(typeof i=="undefined"||!i)i="";if(typeof j==
"undefined"||!j)j="";e="";a=="medium"&&(e="padding-top:1px !important;");b.attr("data-shr_status","1");e=SHR4P.jQuery("<div style='float:left; "+e+" margin:0px 0px 0px 10px !important;'/>").get(0);b.replaceWith(e);SHR4P.jQuery(e).append("<div/>");e=SHR4P.jQuery(e).find(":first-child").get(0);gapi.plusone.render(e,{size:a,annotation:g,width:f,expandto:h,onstartinteraction:i,onendinteraction:j,href:decodeURIComponent(c),callback:function(a){SHR4P.googPlusOneUtil.trackPlusOneClick(a,d)}});SHR4P.ga.socialAction({serviceId:305,
serviceAction:"render",link:c})}})},trackPlusOneClick:function(b,c){b.state=="on"?(SHR4P.utils.trackAction({serviceId:304,href:b.href,title:c}),SHR4P.ga.socialAction({serviceId:305,serviceAction:"like",link:b.href})):SHR4P.ga.socialAction({serviceId:305,serviceAction:"unlike",link:b.href})}};
SHR4P.twitterUtil={addTwitterScript:function(){SHR4P.twitterUtil.renderShareaholicTweetButton()},renderShareaholicTweetButton:function(){SHR4P.jQuery(".shareaholic-tweetbutton",".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery,c=b(this);if((c.attr("data-shr_status")||!1)!="1"){var d=c.attr("data-shr_href")||c.attr("shr_href"),a=c.attr("data-shr_title")||c.attr("shr_title"),e=c.attr("data-shr_size")||c.attr("shr_size"),g=c.attr("data-shr_count")||c.attr("shr_count"),f=c.attr("data-shr_lang"),
h="shr-7",i="shr-generic",j=!0,k=!0;SHR4P.debug(c);if(typeof g=="undefined"||!g)g="horizontal";if((typeof d=="undefined"||!d)&&(typeof a=="undefined"||!a))d=encodeURIComponent(document.location.href),a=document.title;else{if(typeof d=="undefined"||!d)d=encodeURIComponent(document.location.href);if(typeof a=="undefined"||!a)a=""}if(typeof e=="undefined"||!e)e="standard";var n="";e=="medium"&&(n="padding-top:1px !important;");if(typeof f=="undefined"||!f)f="en";switch(g){case "horizontal":k=j=!0;break;
case "vertical":j=!0;k=!1;break;case "none":k=j=!1}j&&(h+="-count",i+="-count");j&&k&&(h+="-compact",i+="-compact");if(j){var l=this;if(k)this.style.marginRight="0px",e=document.createElement("div"),l=document.createElement("div"),g=this.parentNode,g.appendChild(l),l.className="shr_compact_div",e.className="shr_compact_tick",e.appendChild(document.createElement("s")),e.appendChild(document.createElement("i")),g.insertBefore(e,l);j&&SHR4P.utils.getTwitShrCnt(d,function(a){l.innerHTML=a.count})}var m=
d,o={title:a,link:m,short_link:"",shortener:SHRSB_Settings.shortener?SHRSB_Settings.shortener:"google",shortener_key:SHRSB_Settings.shortener_key?SHRSB_Settings.shortener_key:"",v:1,apitype:1,apikey:SHR4P.shr_apiKey,twitter_template:SHR4P.shr_twitter_template?SHR4P.shr_twitter_template:"${title} - ${short_link}",service:7};[SHR4P.shr_link,b.param(o)].join("?");d=b(this);a=SHR4P.shr_image||SHR4P.shr_twitter_image;j=SHR4P.shr_image?".shr-7-count{background-position:-57px -80px;}.shr-7-count-compact,.shr-7{height:14px;width:55px;background-position:-228px -79px;}.shr-7-count-compact:hover,.shr-7:hover{height:14px;width:55px;background-position:-228px -100px;}.shr-7-count-compact:active,.shr-7:active{height:14px;width:55px;background-position:-228px -121px;}":
".shr-7-count{background-position:-57px -80px;}.shr-7-count-compact,.shr-7{height:14px;width:55px;background-position:0px 0px;}.shr-7-count-compact:hover,.shr-7:hover{height:14px;width:55px;background-position:0px -21px;}.shr-7-count-compact:active,.shr-7:active{height:14px;width:55px;background-position:0px -41px;}";j+=".shr_compact_div{background:#EFEFEF;border:1px solid #C1C1C1;float:left;font-weight:normal;height:14px;margin-left:1px;min-width:15px;padding:1px 2px 1px 2px;text-align:center;font-size:11px;display:block;margin-top:2px;margin-right:15px;}.shr_compact_tick{float:left;position:relative;z-index:2;width:5px;top:5px;left:2px;border-collapse:separate;border-spacing:2px 2px;margin-top:2px;}.shr_compact_tick i{left:2px;top:-6px;border-right-color:#EFEFEF;font-style:italic;}.shr_compact_tick s{text-decoration:line-through;text-align:left;}.shr_compact_tick s,i{border:solid transparent;border-right-color:#C7C7C7;display:block;position:relative;border-width:5px 5px 0 0;}";
...
j+"</style>"));c.wrap('<div class="shr-7 shareaholic" style="float:left; '+n+' margin:0px 0px 0px 10px !important;"></div>');c.parent().removeClass("shr-7");c.addClass(i);c.addClass(h);SHR4P.debug(c);SHR4P.ga.socialAction({serviceId:7,serviceAction:"render",link:m});SHR4P.utils.isMobileBrowser()||c.click(function(a){SHR4P.ga.socialAction({serviceId:7,serviceAction:"share",link:m});SHR4P.utils.showServiceLet(o,"twitter");a.preventDefault()});c.attr("data-shr_status","1")}})}};
...
if(typeof d=="undefined"||!d)d="button_count";var a=b.attr("data-shr_showfaces");if(typeof a=="undefined"||!a)a="true";var e=b.attr("data-shr_send");if(typeof e=="undefined"||!e)e="false";var g=b.attr("data-shr_action");if(typeof g=="undefined"||!g||g.toLowerCase()!="recommend"&&g.toLowerCase()!="like")g="like";var f=SHR4P.jQuery("<div style='float:left;padding-top:0px !important; margin:0px 5px !important;'/>").get(0);b.replaceWith(f);if(SHR4P.fbUtil.hasFBNameSpace())d=SHR4P.jQuery('<fb:like action="'+
g+'" send = "'+e+'" href="'+c+'"layout="'+d+'" show_faces="'+a+'" width="60" font=""></fb:like>').appendTo(f),typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(d.get(0));else{b="30";e="60";switch(d){case "button_count":e="90";b="21";break;case "box_count":e="60";b="90";break;default:e="60",b="80"}SHR4P.jQuery('<iframe src="https://www.facebook.com/plugins/like.php?app_id=207766518608&amp;href='+c+"&amp;send=false&amp;layout="+d+"&amp;width="+e+"&amp;show_faces="+a+"&amp;action="+
g+"&amp;colorscheme=light&amp;font&amp;height="+b+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+e+"px; height:"+b+'px;" allowTransparency="true"></iframe>').appendTo(f)}SHR4P.ga.socialAction({serviceId:5,serviceAction:"render",link:c})})},addFBConnect:function(){SHR4P.fbUtil.addFBNameSpace();if(!SHR4P.fbUtil.fbConnectAdd)SHR4P.jQuery('<div id="fb-root"></div>').appendTo("body"),window.fbAsyncInit=function(){FB.init({appId:"207766518608",status:!0,cookie:!0,xfbml:!0});
...
266:0,267:0,268:0,269:0,270:1,271:1,272:1,273:1,274:1,275:1,276:1,277:0,278:0,279:0,280:0,281:0,282:3,283:0,284:2,285:0,286:0,287:0,288:0,289:0,290:0,291:0,292:0,293:0,294:6,295:11,296:11,297:11,298:1,299:1,300:1,301:1,302:1,303:11,304:11,305:11,306:11,307:11,308:0,309:0,310:0};
...
297:"TwitThat",298:"Mister-Wong DE",299:"Mister-Wong CN",300:"Mister-Wong ES",301:"Mister-Wong FR",302:"Mister-Wong RU",303:"Facebook Like",304:"Facebook Send",305:"Google +1",306:"Shareaholic More",307:"Shareaholic All",308:"Buffer",309:"Pinterest",310:"Quora"};
