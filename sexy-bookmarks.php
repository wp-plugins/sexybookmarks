...
function sexy_settings_page() {
	...
	if($_POST['custom-mods'] == 'yes' || $sexy_plugopts['custom-mods'] == 'yes') {
		if(is_admin() === true && !is_dir(WP_CONTENT_DIR.'/sexy-mods')) {
			...
			copy($sexy_oldloc.'images/icons/nostar.png', $sexy_newloc.'images/icons/nostar-small.png');
			copy($sexy_oldloc.'images/icons/1star.png', $sexy_newloc.'images/icons/1star-small.png');
			copy($sexy_oldloc.'images/icons/2star.png', $sexy_newloc.'images/icons/2star-small.png');
			copy($sexy_oldloc.'images/icons/3star.png', $sexy_newloc.'images/icons/3star-small.png');
			copy($sexy_oldloc.'images/icons/4star.png', $sexy_newloc.'images/icons/4star-small.png');
			copy($sexy_oldloc.'images/icons/5star.png', $sexy_newloc.'images/icons/5star-small.png');
		}
	}
