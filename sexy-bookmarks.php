...
$sexy_plugopts = array(
	...
	'useShortener' => '1', //option to allow users NOT to use a URL shortener if they so choose
);
				...
				<div class="box-mid-body" id="toggle2">
					<div class="padding">
						...
						<div id="twitter-defaults"<?php if(!in_array('sexy-twitter', $sexy_plugopts['bookmark'])) { ?> class="hide"<?php } ?>>
							...
							<div id="urlshortenerselection" <?php if($sexy_plugopts['useShortener'] != '1') { ?>class="hide"<?php } ?>>
